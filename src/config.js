...
export const LETTER = {
  ...
  lines: [
    ...
    'С тобой интересно',
    'С тобой уютно',
    'С тобой можно и потусить',
    'Мне нравится, что ты дизайнер и любишь всё эстетичное',
    'У тебя приятный характер',
    'И темперамент тоже',
  ],
  // Подпись: впиши своё, например «Твой Б.». Пустая строка — без подписи.
  signature: '',
}
